...
Vec3::Vec3(const lint gX, const lint gY, const lint gZ, const Ogre::Real fX, const Ogre::Real fY, const Ogre::Real fZ) : Vector3(fX, fY, fZ), _g_x(gX), _g_y(gY), _g_z(gZ) {

}

Vec3::Vec3(const lint agCoordinate[3], const Ogre::Real afCoordinate[3]) : Vector3(afCoordinate), _g_x(agCoordinate[0]), _g_y(agCoordinate[1]), _g_z(agCoordinate[2]) {
...
Vec3::Vec3(lint * const g, Ogre::Real * const r) : Vector3(r), _g_x(g[0]), _g_y(g[1]), _g_z(g[2]) {

}

Vec3::Vec3(const lint gscaler, const Ogre::Real scaler) : Vector3(scaler), _g_x(gscaler), _g_y(gscaler), _g_z(gscaler) {
